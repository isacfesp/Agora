...
INSERT INTO `alumno` VALUES (4,'03252001','2','Moreno','Pacheco','Carlos Manuel','2007-01-13',18,'MOPC070113HMCRCRA0','5615151213','5656232625','dev@gmail.com','Calle','Teoloyucan',54830,'Municipio','apaterno','amaterno','nombre','+52 5548726548','+52 5645156852','correo@gmail.com','apaterno','amaterno','nombre','Padre','+52 5645156852','inactivo'),(5,'03251005','1','Tommo','Tomlinson','Louis','1991-12-24',33,'VIVS070119MMCVRRA0','0987654321','1234567890','tommoway@gmail.com','43','Otro',54850,'Yorkshire','Tomlinson','oishgvior','kjshgferi','4567832918','34567981902','prueba@gmail.com','Edward','Styles','Harry','amigo','1234567890','inactivo'),(6,'03252006','2','Tommo','Tomlinson','Louis','1991-12-24',33,'VIVS070119MMCVRRA0','0987654321','1234567890','tommoway@gmail.com','43','Paseos del Bosque',54850,'Yorkshire','Tomlinson','oishgvior','kjshgferi','4567832918','34567981902','prueba@gmail.com','Edward','Styles','Harry','amigo','1234567890','inactivo');
...
INSERT INTO `caja` VALUES (1,4,2000,'2025-06-16','Efectivo','Inscripción');
...
CREATE TABLE `documentacion` (
  ...
  KEY `id_alumno` (`id_alumno`),
  CONSTRAINT `documentacion_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`id_alumno`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `documentacion` VALUES (1,6,0,0,0);
...
INSERT INTO `imagenes` VALUES (7,'uploads/6850910610b40_Screenshot20250616154724edit18922066744082.jpg',1);
...
INSERT INTO `inscripcion` VALUES (4,4,1),(5,5,1),(6,6,1);
...
INSERT INTO `usuario` VALUES (1,'dev@gmail.com','password','Dev','','',1,1,'2025-06-04 02:08:33',0,483535);
...
-- Dump completed on 2025-06-18 20:43:00
