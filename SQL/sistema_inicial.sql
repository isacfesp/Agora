...
-- Se elimina la base de datos si ya existe para empezar desde cero.
DROP DATABASE IF EXISTS agora;

-- Se crea la base de datos con el conjunto de caracteres y cotejamiento adecuados.
...
-- TABLAS SIN DEPENDENCIAS EXTERNAS (O DEPENDENCIAS YA CREADAS)
